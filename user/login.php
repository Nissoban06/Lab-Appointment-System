...
if (isset($_POST['login'])) {
	...
	$sql = "SELECT id,email FROM tblpatients WHERE email=:email and password=:password";
...
<body class="simple-page">
	...
	<div class="simple-page-wrap">
		...
		<div class="simple-page-form animated flipInY" id="login-form">
			<h4 class="form-title m-b-xl text-center">Sign In With Your ABC Laboratories Account</h4>
